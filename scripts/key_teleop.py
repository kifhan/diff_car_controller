...
class SimpleKeyTeleop():
    def __init__(self, interface):
        ...
        self._forward_rate = rospy.get_param('~forward_rate', 1.4)
        ...
        self.diff_car = car(0.06,0.3)
        self.diff_car.run_mode()
    ...
    def _publish(self):
        ...
        twist = self._get_twist(self._linear, self._angular)
        self._pub_cmd.publish(twist)
        self.diff_car.set_car_vel(self._linear, self._angular)
